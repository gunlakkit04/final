...
const styles = {
  ...
  backBtn: { textDecoration: "none", color: "#0f5c2e", fontWeight: 700, background: "#e5f4ea", padding: "10px 14px", borderRadius: 10 },
  ...
  primaryBtn: { width: "100%", background: "#0f5c2e", color: "#fff", border: "none", borderRadius: 12, padding: "14px", fontWeight: 700, cursor: "pointer", fontSize: 16 },
